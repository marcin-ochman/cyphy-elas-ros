...
class Elas
{
  ...
  public:
    ...
    void process(uint8_t* I1, uint8_t* I2, float* D1, float* D2, const int32_t* dims, const Parameters& params);
  ...
  private:
    ...
    void removeRedundantSupportPoints(int16_t* D_can, int32_t D_can_width, int32_t D_can_height, int32_t redun_max_dist,
    ...
    // matching
    inline void updatePosteriorMinimum(__m128i* I2_block_addr, const int32_t& d, const int32_t& w, const __m128i& xmm1,
                                       __m128i& xmm2, int32_t& val, int32_t& min_val, int32_t& min_d);
    inline void updatePosteriorMinimum(__m128i* I2_block_addr, const int32_t& d, const __m128i& xmm1, __m128i& xmm2,
    ...
    void leftRightConsistencyCheck(float* D1, float* D2, bool subsampling, int32_t lr_threshold);

    // postprocessing
    void removeSmallSegments(float* D, int32_t speckle_size, float speckle_sim_threshold, bool subsampling);
    void gapInterpolation(float* D, int32_t ipol_gap_width, bool add_corners, bool subsampling);

    // optional postprocessing
    void adaptiveMean(float* D, bool subsampling);
    void median(float* D, bool subsampling);
